 ...
 */
UCLASS()
class MUKSI_API UListDataObject_String : public UListDataObject_Value
{
	GENERATED_BODY()
...
UCLASS()
class MUKSI_API UListDataObject_StringBool : public UListDataObject_String
{
	GENERATED_BODY()

public:
	void OverrideTrueDisplayText(const FText& InNewTruDisplayText);
...
UCLASS()
class MUKSI_API UListDataObject_StringEnum : public UListDataObject_String
{
	GENERATED_BODY()
...
UCLASS()
class MUKSI_API UListDataObject_StringInteger : public UListDataObject_String
{
	GENERATED_BODY()
